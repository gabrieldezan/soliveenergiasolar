INSERT INTO `informacoes_gerais`(`nome_empresa`, `titulo`, `descricao`, `whatsapp`, `celular1`, `celular2`, `email`, `email_contato`, `envio_host`, `envio_porta`, `envio_email`, `envio_senha`, `favicon`, `logo_principal`, `logo_secundaria`) VALUES ('Nome da Empresa', 'Titulo do Site', '', '', '', '', 'gdezan94@gmail.com', '', '', '', '', '', '', 'logo-nome-da-empresa-201911061509.jpg', '');
...
INSERT INTO `cidade` (`id_ cidade `, `nome`, `id_estado`) VALUES
