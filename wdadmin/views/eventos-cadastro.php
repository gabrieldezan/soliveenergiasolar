<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/eventos">Eventos</a></li>
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_eventos_cadastro" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea rows="3" class="form-control form-control-sm" id="inputMapa" name="inputMapa" placeholder="<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3599.157569570895!2d-49.319699685852235!3d-25.56642398372577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDMzJzU5LjEiUyA0OcKwMTknMDMuMCJX!5e0!3m2!1spt-BR!2sbr!4v1574213039076!5m2!1spt-BR!2sbr' width='600' height='450' frameborder='0' style='border:0;' allowfullscreen=''></iframe>"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Valor (ingresso normal)*</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Valor (ingresso com adicional)</label>
                                    <div class="col-sm-8">
                                        <div class="input-group input-group-sm">
                                            <div class="input-group-prepend"><span class="input-group-text">R$</span></div>
                                            <input type="tel" class="form-control form-control-sm" id="inputValorAdicional" name="inputValorAdicional" placeholder="0,00" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script src="<?php echo URL ?>wdadmin/scripts/eventos-cadastro.js"></script>