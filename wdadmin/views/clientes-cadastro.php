<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Clientes</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/clientes">Clientes</a></li>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="botao_novo">
                            <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/clientes/cadastro">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_clientes" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="inputDescricao" name="inputDescricao" placeholder="ex.: Web Dezan" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Endereço</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="inputEndereco" name="inputEndereco" placeholder="ex.: Av. Brasil, 1000 Centro" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Estado</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control form-control-sm" id="inputEstado" name="inputEstado" placeholder="ex.: Paraná" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Telefone</label>
                                    <div class="col-sm-2">
                                        <input type="tel" class="form-control form-control-sm" id="inputTelefone" name="inputTelefone" placeholder="ex.: (00) 0000-0000" />
                                    </div>
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Link</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" id="inputLink" name="inputLink" placeholder="ex.: https://webdezan.com.br" />
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script src="<?php echo URL ?>wdadmin/scripts/clientes-cadastro.js"></script>